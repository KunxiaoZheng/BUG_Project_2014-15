 ...
 */
#define MY_DEFAULT_HOST_NAME			"CHIPKIT"
...
#define MY_DEFAULT_IP_ADDR_BYTE1        (0ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (0ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (0ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (0ul)
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(18720ul)
	#define TCP_PIC_RAM_SIZE					(6240ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] = 
		{
			...
			//{TCP_PURPOSE_HTTP_SERVER, TCP_PIC_RAM, 1500, 1500},
			{TCP_PURPOSE_DEFAULT, TCP_ETH_RAM, 1536, 1536},
			{TCP_PURPOSE_DEFAULT, TCP_ETH_RAM, 1536, 1536},
			{TCP_PURPOSE_DEFAULT, TCP_ETH_RAM, 1536, 1536},
			{TCP_PURPOSE_DEFAULT, TCP_ETH_RAM, 1536, 1536},
			{TCP_PURPOSE_DEFAULT, TCP_ETH_RAM, 1536, 1536},
			...
			{TCP_PURPOSE_DEFAULT, TCP_PIC_RAM, 1536, 1536},
			{TCP_PURPOSE_DEFAULT, TCP_PIC_RAM, 1536, 1536},
		};

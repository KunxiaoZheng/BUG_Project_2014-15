/************************************************************************/
/*																		*/
/*	MX7cK-SPI-ENC424J600.x                                              */
/*																		*/
/*	ENC424J600	configuration for the MX7cK 			                */
/*																		*/
/************************************************************************/
/*	Author: 	Keith Vogel 											*/
...
/*																		*/
/************************************************************************/
#ifndef MX7cK_SPI_ENC424J600_X
#define MX7cK_SPI_ENC424J600_X
...
#define ENC100_SPI_IF			(IFS0bits.SPI4RXIF)
#define ENC100_SSPBUF			(SPI4BUF)
#define ENC100_SPICON1			(SPI4CON)
#define ENC100_SPISTATbits		(SPI4STATbits)
#define ENC100_SPICON1bits		(SPI4CONbits)
#define ENC100_SPIBRG			(SPI4BRG)

#define DNETcKInitNetworkHardware() {ENC100_CS_IO = 1;ENC100_CS_TRIS = 0;}

#endif // MX7cK_SPI_ENC424J600_X

...
/*																		*/
/************************************************************************/
#ifndef MX4cK_SPI_ENC28J60_X
#define MX4cK_SPI_ENC28J60_X
...
#define ENC_RST_TRIS        (TRISDbits.TRISD4)      // pin 9
#define ENC_RST_IO          (LATDbits.LATD4)

// no analog pins to worry about
#define DNETcKInitNetworkHardware() {ENC_CS_IO = 1;ENC_CS_TRIS = 0;}

#endif // MX4cK_SPI_ENC28J60_X

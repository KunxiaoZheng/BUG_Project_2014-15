...
/*																		*/
/************************************************************************/
#ifndef MAX32_SPI_ENC424J600_X
#define MAX32_SPI_ENC424J600_X
...
#define ENC100_ISR_ENABLE		(IEC0bits.INT1IE)
#define ENC100_ISR_FLAG			(IFS0bits.INT1IF)
#define ENC100_ISR_POLARITY		(INTCONbits.INT1EP)
#define ENC100_ISR_PRIORITY		(IPC2bits.INT1IP)
